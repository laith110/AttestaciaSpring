...
public class Product {
    ...
    @Min(value = 1,message = "Вес товара не может быть отрицательным или нулевым")
    ...
    public Product(int id, String title, String description, float price, float weight, String warehouse, String seller, Category category, LocalDateTime dateTime, List<Image> imageList) {
        this.id = id;
        this.title = title;
