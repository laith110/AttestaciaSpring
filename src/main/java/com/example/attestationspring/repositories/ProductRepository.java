...
public interface ProductRepository extends JpaRepository<Product, Integer> {
    ...
    //Поиск всех продуктов по части наименование продукта не зависимости от регистра
    List<Product> findByTitleContainingIgnoreCase(String name);

    //Поиск по наименованию и фильтрации по диапазону цены
    ...
    //Поиск по наименованию и фильтрации по диапазону цены,а так же сортировка по возрастанию цены
    ...
    //Поиск по наименованию и фильтрации по диапазону цены,а так же сортировка по убыванию цены
    ...
    //Поиск по наименованию и фильтрации по диапазону цены,сортировка по возрастанию цены ,а также фильтраци по категории
    ...
    //Поиск по наименованию и фильтрации по диапазону цены,сортировка по убыванию цены ,а также фильтраци по категории
